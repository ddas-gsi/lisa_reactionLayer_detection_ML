        ...
        try:
            with open("latest_batch.json", "r") as f:
                ...
                with placeholder.container():
                    ...
                    fig = px.histogram(df, x="Layer", color="Layer", nbins=3, title="Layer Distribution (Updates every second)")
                    ...
                    with col1:
                        ...
                        fig_l0.update_layout(xaxis_range=[900, 1100])
                    ...
                    with col2:
                        ...
                        fig_l1.update_layout(xaxis_range=[900, 1100])
                        # st.plotly_chart(fig_l1, use_container_width=True, key=f"hist_l1_{update_counter}")
                        st.plotly_chart(fig_l1, use_container_width=True)

                    fig_tot = px.histogram(df, x="x3", color="Layer", title="dE_Tot Distribution", nbins=100, range_x=[1700,2300])
